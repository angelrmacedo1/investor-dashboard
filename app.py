...
st.markdown(
    "Crafted by **Angel Macedo** — Get a fast, visual breakdown of any stock's valuation and performance. "
    "Perfect for retail investors, students, or aspiring analysts."
)
...
if ticker_input:
    try:
        ...
        with col1:
            ...
            fig.update_layout(
                title=f"{ticker_input} - 6 Month Closing Price",
                xaxis_title="Date",
